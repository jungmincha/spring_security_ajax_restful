...
<div class = "container">
   <table class="table table-bordered" border = "1" id="list-table" width="500" cellpadding="0" cellspacing="0" border="1">
      <form id="replyForm" action="${pageContext.request.contextPath}/restful/board/${reply_view.bId}" method="post">
...
<td>
<input type = "text" id = "bName" value ="${reply_view.bName}"  style="width:100%; height:100%;">
...
<td>
<input type = "text" id = "bTitle" value ="${reply_view.bTitle}" style="width:100%; height:100%;">
</td>
</tr>
...
<tr>
<td style="text-align:center"> <input type = "submit" value = "답변완료">
